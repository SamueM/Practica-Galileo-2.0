...
$mensaje[NOMBRE_INCORRECTO]="El nombre no es correcto (Mín 3 y Máx 20 caracteres.No puede ser un campo vacío, no puede empezar por números,sí puede contener espacios en blanco y no puede contener caracteres especiales)";
$mensaje[APELLIDO_INCORRECTO]="El apellido no es correcto (Mín 3 y Máx 20 caracteres.No puede ser un campo vacío, no puede empezar por números,sí puede contener espacios en blanco y no puede contener caracteres especiales)";
